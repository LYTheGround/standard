        ...
        <div class="card-box">
                ...
                <div class="form-group">
                    <div class="profile-img-wrap">
                        <img class="inline-block"
                             src="{{ ($company->info_box->brand) ? asset('storage/' . $company->info_box->brand) : asset('img/placeholder.png') }}" title="user"
                             alt="user">
                        <div class="fileupload btn btn-default">
                            <span class="btn-text">{{ __('validation.attributes.edit') }}</span>
                            <input class="upload input-file" name="brand_" type="file">
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 text-right">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-edit"></i> {{ __("company/company.edit") }}</button>
                </div>
            </div>
            {{ Form::close() }}
        </div>
